SELECT
	...
	ROUND(school_xyj_bzxzdds/7) school_xyj_bzrjxzdds,
	...
	FROM merchant_yunying_data WHERE rq=CONCAT(DATE_FORMAT(DATE_SUB( CURDATE( ), INTERVAL  7 DAY ),'%m.%d'),'-',DATE_FORMAT(DATE_SUB( CURDATE( ), INTERVAL  1 DAY ),'%m.%d'));
